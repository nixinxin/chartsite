...
; (function ($) {
    $.fn.fix = function (options) {
        ...
        this.each(function () {
            //获取对象
            var thisBox = $(this),
				closeBtn = thisBox.find(".qos-close"),
				show_btn = thisBox.find(".qos-btn"),
				contentBox = thisBox.find(".qos-group"),
            ...
            show_btn.bind("click", function () {
                ...
                thisBox.removeClass("showHeight");
