...
case 40:g(a,0,b);break;case 27:d.allowSelect&&bb.release();break;case 9:return!0}return!1}var b=a('<input type="radio" />').css({left:"-120px",width:"12px",'z-index':-1}).addClass("jcrop-keymgr"),c=a("<div />").css({position:"absolute",overflow:"hidden"}).append(b);return d.keySupport&&(b.keydown(i).blur(f),h||!d.fixedSupport?(b.css({position:"absolute",left:"-20px"}),c.append(b).insertBefore(D)):b.insertBefore(D)),{watchKeys:e}}();Z.support&&M.bind("touchstart.jcrop",Z.newSelection),J.hide(),br(!0);var bs={setImage:bp,animateTo:bf,setSelect:bg,setOptions:bk,tellSelect:bi,tellScaled:bj,setClass:be,disable:bl,enable:bm,cancel:bn,release:bb.release,destroy:bo,focus:bd.watchKeys,getBounds:function(){return[E*T,F*U]},getWidgetSize:function(){return[E,F]},getScaleFactor:function(){return[T,U]},getOptions:function(){return d},ui:{holder:G,selection:K}};return g&&G.bind("selectstart",function(){return!1}),A.data("Jcrop",bs),bs},a.fn.Jcrop=function(b,c){var d;return this.each(function(){if(a(this).data("Jcrop")){if(
...
function upInfo(){var t=$("#infoForm").serializeJSON();t.username=t.first_name;console.log(t),0==t.name.trim().length?BootstrapDialog.alert("昵称不能为空！",function(){setTimeout(function(){$('input[name="first_name"]').focus()},1)}):$.ajax({url:"/users/1/",type:"PUT",data:t,success:function(){BootstrapDialog.alert("修改成功！",function(){location.reload()})},error:function(t){BootstrapDialog.alert(400==t.status?"昵称已存在！":"修改失败！")}})}function upAvatar(t){$.ajax({url:"/users/1",type:"PUT",data:{avatar:t},success:function(){$("#icon").val(""),$(".avatar img").attr("src",t),$(".profile img").attr("src",t)},error:function(){BootstrapDialog.alert("上传失败，请稍后再试！")}})}function changePass(){var t,a=$("#passwordForm").serializeJSON();return 0==a.password.length?t="请输入新密码！":a.password.length<6?t="密码长度小于6！":a.password!==a.confirmPass&&(t="两次输入的密码不一致！"),t?BootstrapDialog.alert(t):void $.ajax({url:"/users/1/",type:"PUT",data:a,success:function(t,a){BootstrapDialog.alert("密码已修改！"),$(":input","#passwordForm").val("")},error:function(){BootstrapDialog.alert("密码修改失败！")}})}function attach(t,a){return $.Jcrop("#pv",{allowSelect:!1,setSelect:[(t-100)/2,(a-100)/2,(t-100)/2+100,(a-100)/2+100]})}$(function(){var params=HZ.getParams();params.type&&"1"==params.type&&$("li:eq(1) a","#tabs").tab("show");var birthday=$("#birthday"),myDate=new Date(birthday.attr("data-value")),year=myDate.getFullYear(),month=myDate.getMonth()+1,day=myDate.getDate();10>month&&(month="0"+month),10>day&&(day="0"+day),birthday.datepicker({format:"yyyy/mm/dd",autoclose:!0}).val(year+"/"+month+"/"+day);var api,icon=$("#icon");icon.change(function(t){var a,e=t.target.files[0];if(e){if(e.type.match("image/*")||(a="格式错误，请重新选择!"),e.size>512e3&&(a="图片大小超出范围，请重新选择!"),a)return $(this).val(""),BootstrapDialog.alert(a);var o=new FileReader;o.onload=function(){return function(t){var a=new Image,e=350,o=570;a.src=t.target.result,a.onload=function(){a.height>e&&(a.width*=e/a.height,a.height=e),a.width>o&&(a.height*=o/a.width,a.width=o);var t=document.createElement("canvas"),n=t.getContext("2d");t.width=a.width,t.height=a.height,n.drawImage(a,0,0,a.width,a.height);var i=t.toDataURL("image/jpeg"),r=new Image;r.src=i;var c=$("<img>").attr({id:"pv",src:i}).css({display:"block",margin:"0 auto"});BootstrapDialog.show({title:"请选择上传图像",message:c,closable:!0,btnCancelLabel:"取消",btnOKLabel:"上传头像",btnOKClass:"btn-success",onshown:function(){api&&api.destroy(),(a.width>100||a.height>100)&&(api=attach(a.width,a.height))},onhidden:function(){icon.val("")},buttons:[{label:"取消",action:function(t){t.close()}},{label:"上传头像",cssClass:"btn-success",icon:"glyphicon glyphicon-cloud-upload",action:function(t){var a={x:0,y:0,w:r.width,h:r.height},e=document.createElement("canvas"),o=e.getContext("2d");e.width=100,e.height=100,api&&(a=api.tellSelect()),r.width<=100&&(a.x=0,a.w=r.width),r.height<=100&&(a.y=0,a.h=r.height),o.drawImage(r,a.x,a.y,a.w,a.h,0,0,100,100),upAvatar(e.toDataURL("image/jpeg")),t.close()}}]})}}}(e),o.readAsDataURL(e)}});var $gender=$("#gender");$gender.attr("checked",eval($gender.attr("data-check"))),$("#upAvatar").on("click",function(){icon.click()});var job=$("#jobHid").val();$("#job option[value='"+job+"']").attr("selected",!0)});
