...
from apps.users.views import PhoneCodeViewset, UserViewset, EmailCodeViewset, UserAccess, ImageCodeViewset
...
# 配置图片验证码url
router.register(r"captcha/login", ImageCodeViewset, base_name='emailcodes')
